...
local table = {
  ...
  ["CMPSD"] = "Compare String Operands / Compare Scalar Double-Precision Floating-Point Value",
  ...
  ["JCXZ"] = "E.	Valid	Jump short if CX register is 0",
  ["JECXZ"] = "Jump short if ECX register is 0",
  ["JRCXZ"] = ".E.	Jump short if RCX register is 0",
  ["JE"] = "Jump short if equal (ZF=1)",
  ["JG"] = "Jump short if greater (ZF=0 and SF=OF)",
  ["JGE"] = "Jump short if greater or equal (SF=OF)",
  ["JL"] = "Jump short if less (SF≠ OF)",
  ["JLE"] = "Jump short if less or equal (ZF=1 or SF≠ OF)",
  ...
  ["JNG"] = "Jump short if not greater (ZF=1 or SF≠ OF)",
  ["JNGE"] = "Jump short if not greater or equal (SF≠ OF)",
  ...
  ["MOVSD"] = "Move Data from String to String / Move or Merge Scalar Double-Precision Floating-Point Value",
  ...
  -- registers
  ["RAX"] = "Accumulator - 64bit Scratch Register",
  ["RBX"] = "Base - 64bit Preserved Register",
  ["RCX"] = "Counter - 64bit Scratch Register",
  ["RDX"] = "Data - 64bit Scratch Register",
  ["RSI"] = "Source Index - 64bit Scratch Register",
  ["RDI"] = "Destination Index - 64bit Scratch Register",
  ["RBP"] = "Base Pointer - 64bit Preserved Register",
  ["RSP"] = "Stack Pointer - 64bit Preserved Register",
  ["R8"] = "64bit Scratch Register",
  ["R9"] = "64bit Scratch Register",
  ["R10"] = "64bit Scratch Register",
  ["R11"] = "64bit Scratch Register",
  ["R12"] = "64bit Preserved Register",
  ["R13"] = "64bit Preserved Register",
  ["R14"] = "64bit Preserved Register",
  ["R15"] = "64bit Preserved Register",
  ["RIP"] = "Instruction Pointer - 64bit Register",
  ["EAX"] = "Accumulator - 32bit Scratch Register",
  ["EBX"] = "Base - 32bit Preserved Register",
  ["ECX"] = "Counter - 32bit Scratch Register",
  ["EDX"] = "Data - 32bit Scratch Register",
  ["ESI"] = "Source Index - 32bit Scratch Register",
  ["EDI"] = "Destination Index - 32bit Scratch Register",
  ["EBP"] = "Base Pointer - 32bit Preserved Register",
  ["ESP"] = "Stack Pointer - 32bit Preserved Register",
  ["EIP"] = "Instruction Pointer - 32bit Register",
  ["AX"] = "Accumulator - 16bit Scratch Register",
  ["BX"] = "Base - 16bit Preserved Register",
  ["CX"] = "Counter - 16bit Scratch Register",
  ["DX"] = "Data - 16bit Scratch Register",
  ["SI"] = "Source Index - 16bit Scratch Register",
  ["DI"] = "Destination Index - 16bit Scratch Register",
  ["BP"] = "Base Pointer - 16bit Preserved Register",
  ["SP"] = "Stack Pointer - 16bit Preserved Register",
  ["IP"] = "Instruction Pointer - 16bit Register",
  ["AH"] = "Accumulator High - 8bit Scratch Register",
  ["BH"] = "Base High - 8bit Preserved Register",
  ["CH"] = "Counter High - 8bit Scratch Register",
  ["DH"] = "Data High - 8bit Scratch Register",
  ["AL"] = "Accumulator Low - 8bit Scratch Register",
  ["BL"] = "Base Low - 8bit Preserved Register",
  ["CL"] = "Counter Low - 8bit Scratch Register",
  ["DL"] = "Data Low - 8bit Scratch Register",
  ["RFLAGS"] = "Flags - 64bit Register",
  ["EFLAGS"] = "Flags - 32bit Register",
  ["FLAGS"] = "Flags - 16bit Register",
  ["CS"] = "Code Segment - 16bit Register",
  ["DS"] = "Data Segment - 16bit Register",
  ["ES"] = "Extra Segment - 16bit Register",
  ["FS"] = "Extra Segment - 16bit Register",
  ["GS"] = "Extra Segment - 16bit Register",
  ["SS"] = "Stack Segment - 16bit Register",
}

local hover = function()
  local word = string.upper(vim.fn.expand('<cword>'))
  if table[word] then
    vim.notify(table[word])
  end
end

vim.keymap.set("n", "K", hover, { noremap = true, silent = true })
